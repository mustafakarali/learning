                ...
                <p>                 
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><h5>Overall Ranking - Third Year</h5></div>
                                        ...
                                        <tbody>
                                            <?php
													...
													while($row = mysql_fetch_array($sql))
													{
														...
														if(isset($_POST['acti']))
														{
															$activate = mysql_query("INSERT INTO tbl_achievethird(cgpa,student_id,first_name,middle_name,last_name,program,status)
														...
														{
															$deactivate = mysql_query("UPDATE tbl_achievethird SET status='0'") or die(mysql_error());
