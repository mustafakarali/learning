<?php
	...
	$sql1 = mysql_query("Select * FROM tbl_instructor ORDER BY id DESC LIMIT 1")
						or die(mysql_error());
	...
	echo "<script>alert (\"Instructor's Account Successfully Created!\")</script>";
?>  
<!DOCTYPE html>
<html>
    
    <head>
        <title>Administrator | Review Instructor</title>
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
										...
										<li>
	                                        <a href="createInstructor.php">Create Instructor</a> <span class="divider">/</span>	
	                                    </li>
	                                    <li>Review</li>
	                                </ul>
                            	</div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form method="post" action="" class="form-horizontal">
                                      <fieldset>
                                        <legend>Review of Newly Created Instructor</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Instructor ID </label>
                                          <div class="controls">
