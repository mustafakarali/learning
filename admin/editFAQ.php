	...
	if(!($_SESSION['login'])) {
		...
		$id = $_REQUEST['myVar'];
		$myQuery = mysql_query("SELECT * FROM tbl_faq WHERE faq_id='$id'");
		...
		if(isset($_POST['btnUpdate'])){
			...
			if(empty($title) || empty($ans))
			{
				$msg = '<font color="red"><i>All fields should be filled out!</i></font>';
			}
			else{
				 $mySql =	mysql_query("UPDATE tbl_faq SET title ='$title', answer='$ans' WHERE faq_id='$id'")
...
<html>
    ...
    <head>
        <title>Administrator | Edit FAQs</title>
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit FAQ</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form method="post" action="" class="form-horizontal">
                                      <fieldset>
                                        <legend>FAQ Editor</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Title </label>
                                          <div class="controls">
                                            <input type="text" class="span6" id="typeahead"  name="title" data-provide="typeahead" data-items="4" placeholder="Title" value="<?php echo $title ?>">
                                          </div>
										  <div class="controls">
	 </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                             <textarea id="tinymce_full" name="answer"><?php echo $ans ?></textarea>
                                          </div>
										  <div class="controls">
	 </div>
                                        </div>
                                        <div class="form-actions">
                                          <button type="submit" name="btnUpdate" class="btn btn-primary">Update FAQ</button>
