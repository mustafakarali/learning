                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="../_public/classlist.php">Class List</a> <span class="divider">/</span>	
	                                    </li>
	                                    <li>Activity</li>
	                                </ul>
                            	</div>
                            ...
                            <div class="block">
								...
								<?php
									if(isset($_REQUEST['id'])) {
										...
										$sql = mysql_query("SELECT * FROM tbl_activity  WHERE activity_id='$activityID'")
													or die(mysql_error()) ;
										...
										if(isset($_POST['btnSubmit'])) {
											...
											/*else if($fileSize>$size) {
												...
												mysql_query("INSERT INTO tbl_activity_grade (class_class_id, activity_id, file, filename, date_submit, time_submit, grade_id)
																	VALUES ('$enrollID','$activityID','$content2','$fileName','$date','$time','N/A')")
																	or die(mysql_error());
																	
												$msg = 'Your activity has been uploaded successfully!';
											}
										...
										{
											echo '<h3>You already submitted for this activity</h3>';
										}
										else {
									?>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
											<?php
												...
												{?>
													<tr>
														<td colspan="4"><?php echo "No Activity has been uploaded for this class.<br>"; ?></td>
													</tr><?php
												} 
												else
												{
