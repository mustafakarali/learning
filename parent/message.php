                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid">
							...
							<?php 
                                ...
                                <div class="block-content collapse in">
                                    <table class="table table-striped">
										...
										<?php 
											$z=0;
											$sql="select * from tblchat WHERE sender = '$insID' AND sender_b='$parentID' AND id='$chatID2' order by id DESC";
													...
													$y=0;
													$l=0;
													$sql="select * from tblchat WHERE sender = '$insID' AND sender_b='$parentID' AND status='$chatID2' ";
													$query=mysql_query($sql);
													while ($row=mysql_fetch_array($query))
													{
														$chatID = $row['id'];
                            ...
                            <div class="block">
                                ...
                                <?php  $ggg = mysql_query("SELECT * FROM tblchat WHERE sender_b='$parentID'") or die(mysql_error());
                            ...
                            if($gg2) { ?>
                                <div class="block-content collapse in">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
										<?php 
											$sql="select * from tblchat WHERE sender = '$insID' AND sender_b='$parentID' order by id DESC";
													$query=mysql_query($sql);
													while ($row=mysql_fetch_array($query))
													{
														$status = $row['status'];
														...
														echo "<tr>";
														echo "<td><a href=\"message.php?conver=$chatID\">$fname_ins $lname_ins<a/></td>";
														echo '<td>'.'<div class="pull-right">'.$row['time'].'</div>'.' :'.'&nbsp;&nbsp;'.$row['msg'].'</td>';
														echo "</tr>";
													}
												?> 
