			...
			if($user=='' && $curr=='' && $new=='' && $conf=='') {
				...
				if($user=='') {
					...
					<strong>Error!</strong> Not a valid current password.
						...
						$myQuery = mysql_query("SELECT * FROM tbl_parent  WHERE password='$newpass'");
					...
					<strong>Error!</strong> New Password and Confirm New Password should match.
								...
								$myQuery = mysql_query("UPDATE tbl_parent SET password='$newpass', pass='$new', status=1 WHERE username='$username'") or die(mysql_error()) ;
								$msg = '<div class="alert alert-success">
										<button class="close" data-dismiss="alert">&times;</button>
										<strong>Success!</strong> Password has been Changed. <a href="../l_parent.php">You can now login</a> </div>';;
...
<html lang="en">
  <head>
    ...
    <title>Change Default Password | Student</title>
    <!-- Bootstrap -->
          ...
          <div class="span6 offset3">
              <div class="center-align">
                <form method="post" action="" class="form-horizontal form-signin-signup">
                  ...
                  <input type="password" name="current" value="<?php echo $pass ?>" required>
