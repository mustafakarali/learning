					...
					<!--Viewing-->
									...
									<form action="" method="post">
                                        ...
                                        <tbody>
											...
											<?php
													$sql = mysql_query("SELECT r.request_date as date, r.request_time as time, r.status as status, e.student_id as studID FROM tbl_request r, tbl_class_class e WHERE r.class_class_id=e.class_class_id ORDER BY r.request_date DESC, r.request_time DESC")
																		or die(mysql_error()) ;
