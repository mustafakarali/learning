<?php
	...
	if(isset($_POST['btnLogin'])) {
		...
		if(empty($d1) || empty($d2)) {
			...
			$myQuery = mysql_query("SELECT * FROM tbl_student  WHERE student_id='$d1' AND password='$d2'")
					   or die(mysql_error()) ;
				...
				if(mysql_num_rows($myQuery)>0) {
					...
					if($status==0){
						...
						$_SESSION['login'] = $login;
						$_SESSION['username'] = $d1;
						header("Location: student/classList.php");
					}
				}
				else {
					$_SESSION['login'] = $login;
                ...
                <form class="form-horizontal form-signin-signup" method="post" action="">
                  ...
                  <div class="remember-me">
                    ...
                    <div class="pull-right">
                      <a href="s_forgot.php">Forgot Password?</a>
                    </div>
