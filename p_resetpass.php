...
$query = mysql_query("select * from tbl_parent where activation_code='$acode'")
or die(mysql_error()); 

if (mysql_num_rows ($query)==1) 
{
$query3 = mysql_query("update tbl_parent set password='$newpass', pass='$npass' where activation_code='$acode'")
or die(mysql_error()); 
        ...
        <div class="row">
          <div class="span6 offset3">
              ...
              <p><h3>Get back into your account</h3>Please enter your activation code. Your changes here will update your password.</p>
                <form action="p_resetpass.php" method="POST" class="form-horizontal form-signin-signup">
