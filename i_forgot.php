...
$query = mysql_query("select * from tbl_instructor where email='$email'") or die(mysqli_error()); 
...
$message .= "http://jetextsteeldetailers.com/fern/i_resetpass.php?email=$email&code=$code";
$message .= "</body></html>";
$headers = "From: $from \n";
...
$query2 = mysql_query("update tbl_instructor set activation_code='$code' where email='$email' ")or die(mysql_error()); 
}
else
{
        ...
        <div class="row">
          <div class="span6 offset3">
              ...
              <p><h3>Get back into your account</h3>Enter your email address to reset your password:</p>
                <form action="i_forgot.php" method="post" class="form-horizontal form-signin-signup">
