<?php
	...
	if(isset($_POST['btnLogin'])) {
		...
		if(empty($d1) || empty($d2)) {
			...
			$myQuery = mysql_query("SELECT * FROM tbl_parent  WHERE username='$d1' AND password='$d2'")
					   or die(mysql_error()) ;
				...
				if(mysql_num_rows($myQuery)>0) {
					...
					if($status==0){
						...
						$_SESSION['pass'] = $pass;
						header("Location: parent/changePassword.php");
					}
					else {
						$login = 1;
						$_SESSION['login'] = $login;
						$_SESSION['username'] = $d1;
						header("Location: parent/classList.php");
					}
				}
				else {
					$_SESSION['login'] = $login;
            ...
            <div class="widget-body"  style="background-color:#FFF;">
              <div class="center-align">
                <form class="form-horizontal form-signin-signup" action="" method="post">
                  <input type="text" name="username" placeholder="Parent ID" required>
                  ...
                  <div class="remember-me">
                    ...
                    <div class="pull-right">
                      <a href="p_forgot.php">Forgot Password?</a>
                    </div>
