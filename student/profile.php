		...
		if(isset($_POST['btnSave'])) {
						...
						if($contact==$newContact && $email==$newEmail) {
							...
							if($contact!=$newContact){
								$myQuery = mysql_query("SELECT * FROM tbl_student  WHERE contact='$newContact'");
								...
								if(mysql_num_rows($myQuery) >0){
									  $msgProfile =  '<div class="alert alert-error" style="min-width:30px;margin-right:10%;margin-top:1%;">
										...
										$myQuery2 = mysql_query("UPDATE tbl_student SET contact='$newContact' WHERE student_id='$studID'")or die(mysql_error()) ;
							...
							if ($email!=$newEmail) {
								$myQuery = mysql_query("SELECT * FROM tbl_student  WHERE email='$newEmail'");
								...
								if(mysql_num_rows($myQuery) >0){
									...
									$myQuery3 = mysql_query("UPDATE tbl_student SET email='$newEmail' WHERE student_id='$studID'") or die(mysql_error()) ;
									$msgProfile =  '<div class="alert alert-success alert-block">
										<a class="close" data-dismiss="alert" href="#">&times;</a>
										<h4 class="alert-heading">Success!</h4> Contact information successfully updated.
									</div>';
