			...
			if($user=='' && $curr=='' && $new=='' && $conf=='') {
				...
				if($user=='') {
					...
					<strong>Error!</strong> New Password and Confirm New Password should match.
								...
								$myQuery = mysql_query("UPDATE tbl_student SET password='$newpass', pass='$new', status=1 WHERE student_id='$username'")
											   or die(mysql_error()) ;
								$msg = '<div class="alert alert-success">
										<button class="close" data-dismiss="alert">&times;</button>
										<strong>Success!</strong> Password has been Changed.<a href="../l_student.php">You can now login</a></div>';
