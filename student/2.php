	...
	if(!($_SESSION['login'])) {
		...
		include("includes/classMenu.php");
								...
								if(isset($_POST['btnRequest'])) {
									...
									mysql_query("INSERT INTO tbl_request(class_class_id, request_date, request_time, status) VALUES ('$enrollID','$current_date','$current_time','0')");
						...
						<form action="" method="post">
								<?php
									...
									if(!$count){
										...
										<button class="close" data-dismiss="alert">&times;</button>
										<strong>Warning!</strong> Not available for viewing.
									</div>';
										echo '<input style="margin-left:15%" type="submit" value="Request for Viewing" class="btn btn-primary" name="btnRequest"></input>';
                ...
                <p>                 
                  ...
                  <p>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
											<?php 
												$sql2 = mysql_query("SELECT c.month, c.day, a.legend  FROM tbl_attendance a, tbl_calendar c WHERE a.class_class_id='$enrollID' AND a.calendar_id=c.calendar_id")
												or die(mysql_error()) ;
												...
												{ 
													...
													echo "<td> <span class=\"input-mini uneditable-input\">$legend</span></td>";
													echo "</tr>";
													}
												}
											?>
