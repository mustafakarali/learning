...
$query = mysql_query("select * from tbl_student where parent_email='$email'") or die(mysqli_error()); 
...
$message .= "http://jetextsteeldetailers.com/fern/p_resetpass.php?code=$code";
$message .= "</body></html>";
$headers = "From: $from \n";
...
$query2 = mysql_query("update tbl_parent p, tbl_student s set p.activation_code='$code' where p.child_id=s.student_id and s.parent_email='$email' ")or die(mysql_error()); 
}
else
{
        ...
        <div class="row">
          <div class="span6 offset3">
              ...
              <p><h3>Get back into your account</h3>Enter your email address to reset your password:</p>
                <form action="p_forgot.php" method="post" class="form-horizontal form-signin-signup">
