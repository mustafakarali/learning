...
$query = mysql_query("select * from tbl_instructor where activation_code='$acode'")
or die(mysql_error()); 

if (mysql_num_rows ($query)==1) 
{
$query3 = mysql_query("update tbl_instructor set password='$newpass', pass='$npass' where activation_code='$acode'")
or die(mysql_error()); 

header ("Location: l_instructor.php");
}
else
{
        ...
        <div class="row">
          <div class="span6 offset3">
              ...
              <p><h3>Get back into your account</h3>Please enter your activation code. Your changes here will update your password.</p>
                <form action="i_resetpass.php" method="POST" class="form-horizontal form-signin-signup">
                ...
                <input type="reset" value="Cancel" class="btn btn-large"></input> <a href="index.php"><input type="button" class="btn btn-warning btn-large" value="Home"></input></a>
